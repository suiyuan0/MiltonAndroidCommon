...
/**
 * Created by milton on 16/9/12.
 */
public class UCropDemoActivity extends UCropBaseActivity {

    private static final String TAG = UCropDemoActivity.class.getSimpleName();
    ...
    protected int getContent() {
        return R.layout.activity_ucrop_demo;
    }
        ...
        if (resultCode == RESULT_OK) {
            if (requestCode == REQUEST_SELECT_PICTURE) {
                ...
                if (selectedUri != null) {
                    ...
                    showToastShort(R.string.toast_cannot_retrieve_selected_image);
                }
    ...
    private void startCropActivity(@NonNull Uri uri) {
        ...
        uCrop.start(UCropDemoActivity.this);
    }
    ...
    private UCrop basisConfig(@NonNull UCrop uCrop) {
        switch (mRadioGroupAspectRatio.getCheckedRadioButtonId()) {
            ...
            default:
                try {
                    ...
                    LogUtil.i(TAG, String.format("Number please: %s", e.getMessage()));
                }
                break;
        }
        ...
        if (mCheckBoxMaxSize.isChecked()) {
            try {
                ...
                LogUtil.e(TAG, "Number please  " + e.getMessage());
            }
        }
    ...
    private void handleCropResult(@NonNull Intent result) {
        ...
        if (resultUri != null) {
            UCropResultActivity.startWithUri(UCropDemoActivity.this, resultUri);
        } else {
            showToastShort(R.string.toast_cannot_retrieve_cropped_image);
        }
    }
    ...
    private void handleCropError(@NonNull Intent result) {
        ...
        if (cropError != null) {
            LogUtil.e(TAG, "handleCropError: " + cropError);
            showToastShort(cropError.getMessage());
        } else {
            showToastShort(R.string.toast_unexpected_error);
        }
    }
