...
public class StatusBarActivity extends BaseActivity implements OnClickListener {
...
//        //songxiujuan add for PLWIN-1922 begin
//        window.addFlags(WindowManager.LayoutParams.FLAG_TRANSLUCENT_STATUS);
//        window.addFlags(WindowManager.LayoutParams.FLAG_TRANSLUCENT_NAVIGATION);
        setContentView(R.layout.activity_statusbar);

        mRLayout = (RelativeLayout) findViewById(R.id.content2);
