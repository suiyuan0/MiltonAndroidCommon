...
import com.milton.common.widget.swipemenu.SwipeMenu;
...
public class SwipeMenuActivity extends BaseActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (isPic == 0) {
            mMainSwipemenu.setFullColor(SwipeMenuActivity.this, R.color.colorPrimary);
        } else {
            mCbPic.setChecked(true);
            if (isBlur) {
                mContentRgBlur.check(R.id.content_rb_blur);
                mMainSwipemenu.setBlur(SwipeMenuActivity.this, R.drawable.dayu, R.color.colorPrimary, 22f);
            } else if (isChangeBlur) {
                mContentRgBlur.check(R.id.content_rb_changeblur);
                mMainSwipemenu.setChangedBlur(SwipeMenuActivity.this, R.drawable.dayu, R.color.colorPrimary);
            } else if (isReverseChangeBlur) {
                mContentRgBlur.check(R.id.content_rb_reversechangeblur);
                mMainSwipemenu.setReverseChangedBlur(SwipeMenuActivity.this, R.drawable.dayu, R.color.colorPrimary);
            } else {

                mContentRgBlur.check(-1);
                mMainSwipemenu.setBackImage(SwipeMenuActivity.this, R.drawable.dayu, R.color.colorPrimary);
            }
        }
        ...
        mCbPic.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton compoundButton, boolean b) {
                ...
                mEditor.commit();
                Intent intent = new Intent(mContext, SwipeMenuActivity.class);
    ...
    class TipAdapter extends RecyclerView.Adapter {
        ...
        public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
            ...
            return new TipViewHolder(LayoutInflater.from(mContext).inflate(R.layout.swipe_menu_item_tip, parent, false));
        }
        ...
        public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
            ...
            if (position == 0) {
                ...
                if (mCbPic.isChecked()) {
                    builder.append("setBackImage(SwipeMenuActivity.this, R.drawable.dayu, R.color.colorPrimary)\n");
                } else {
                    builder.append("setFullColor(SwipeMenuActivity.this, R.color.colorPrimary\n");
                }
                ...
                if (mContentRgBlur.getCheckedRadioButtonId() == R.id.content_rb_blur) { //静态模糊
                    builder.append("setBlur(SwipeMenuActivity.this, R.drawable.dayu, R.color.colorPrimary, 22f)\n");
                }
                if (mContentRgBlur.getCheckedRadioButtonId() == R.id.content_rb_changeblur) { //动态模糊
                    builder.append("setChangedBlur(SwipeMenuActivity.this, R.drawable.dayu, R.color.colorPrimary)\n");
                }
                if (mContentRgBlur.getCheckedRadioButtonId() == R.id.content_rb_changeblur) { //动态模糊
                    builder.append("setReverseChangedBlur(SwipeMenuActivity.this, R.drawable.dayu, R.color.colorPrimary)");
                }
