...
package com.milton.common.widget.slidetablayout;
...
public class SlidingTabLayout extends HorizontalScrollView {
    ...
    private static final int TAB_VIEW_PADDING_DIPS_HORIZONTAL = 16;
    private static final int TAB_VIEW_PADDING_DIPS_VERTICAL = 8;
    ...
    /**
     * Set the custom {@link TabColorizer} to be used. If you only require
     * simple custmisation then you can use
    ...
    protected TextView createDefaultTabView(Context context) {
        ...
        int padding_horizontal = (int) (TAB_VIEW_PADDING_DIPS_HORIZONTAL * getResources().getDisplayMetrics().density);
        int padding_vertical = (int) (TAB_VIEW_PADDING_DIPS_VERTICAL * getResources().getDisplayMetrics().density);
        textView.setPadding(padding_horizontal, padding_vertical, padding_horizontal, padding_vertical);

        if (mTabTextBackgroundResId != -1) {
            textView.setBackgroundResource(mTabTextBackgroundResId);
        }
        if (mTabTextColorId != -1) {
            textView.setTextColor(getResources().getColorStateList(mTabTextColorId));
        }
        if (mTabTextSize != -1) {
    ...
    private int mTabTextBackgroundResId = -1;
    private int mTabTextColorId = -1;
    private float mTabTextSize = -1;

    public void setTabTextBackgroundResource(int res) {
        mTabTextBackgroundResId = res;
    }

    public void setTabTextColor(int res) {
        mTabTextColorId = res;
    }
