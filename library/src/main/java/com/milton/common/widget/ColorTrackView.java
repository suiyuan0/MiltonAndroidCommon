...
public class ColorTrackView extends View {
    ...
    private static final int DIRECTION_LEFT = Gravity.LEFT;
    private static final int DIRECTION_RIGHT = Gravity.RIGHT;
    private static final int DIRECTION_TOP = Gravity.TOP;
    private static final int DIRECTION_BOTTOM = Gravity.BOTTOM;
    ...
    public ColorTrackView(Context context, AttributeSet attrs) {
        ...
        mDirection = ta
                .getInt(R.styleable.ColorTrackView_direction2, mDirection);
