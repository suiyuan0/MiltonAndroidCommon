...
public class LabelView extends View {
    ...
    public LabelView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        Log.e("alinmi", "context = " + context);
        TypedArray ta = context.getTheme().obtainStyledAttributes(attrs, R.styleable.LabelTextView, defStyleAttr, 0);
    ...
    protected void onDraw(Canvas canvas) {
        ...
        Log.e("alinmi", "width = " + getWidth() + ", height = " + getHeight() + ", x = " + (width) / 2 + ", y = " + (mTopPadding + mTextHeight));
        // 绘制修饰文本
