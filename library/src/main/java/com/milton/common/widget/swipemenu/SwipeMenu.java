package com.milton.common.widget.swipemenu;
...
public class SwipeMenu extends ViewGroup {
    ...
    private void initObtainStyledAttr(Context context, AttributeSet attrs) {
        ...
        mDragWipeOffset = (int) array.getDimension(R.styleable.SwipeMenu_sm_dragoffset, ResourceUtil.dp2px(context, 100));
        mMenuOffset = (int) array.getDimension(R.styleable.SwipeMenu_sm_menuoffset, ResourceUtil.dp2px(context, 50));
        ...
        if (backBitmap != null) { //图片背景
            ...
            if (startBlur == 0 && endBlur == 0) { //正常背景
                ...
                if (endBlur == 0) {
                    ...
                    backDrawable = new BitmapDrawable(ResourceUtil.fastblur(getContext(), backBitmap, scale, endBlur));
                }
            }
            if (startBlur != endBlur) { //动态模糊
                ...
                if (startBlur == 0) {
                    ...
                    mBackImageView.setImageBitmap(ResourceUtil.fastblur(getContext(), backBitmap, scale, startBlur));
                }
    ...
    public boolean onInterceptTouchEvent(MotionEvent ev) {
        ...
        switch (action) {
            ...
            case MotionEvent.ACTION_MOVE:
                ...
                if (!isMenuShowing()) {
                    if (x >= ResourceUtil.dp2px(getContext(), mDragWipeOffset)) {
                        return false;
                    }
                }
