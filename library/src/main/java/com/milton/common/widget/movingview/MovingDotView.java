package com.milton.common.widget.movingview;
...
public class MovingDotView extends ViewGroup {
    ...
    private void initObtainStyled(Context context, AttributeSet attrs) {
        ...
        mMaxDotRadius = (int) array.getDimension(R.styleable.MovingDotView_md_dot_max_radius, ResourceUtil.dp2px(getContext(), 10));
        mMinDotRadius = (int) array.getDimension(R.styleable.MovingDotView_md_dot_min_radius, ResourceUtil.dp2px(getContext(), 5));
        ...
        mTextSize = (int) array.getDimension(R.styleable.MovingDotView_md_text_size, ResourceUtil.sp2px(getContext(), 70));
