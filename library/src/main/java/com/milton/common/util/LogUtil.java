...
public class LogUtil {
     ...
     */
    public static void v2(String tag, String message, boolean isShowLog) {
     ...
     * @param isShowLog 是否显示
     */
    public static void v2(String message, boolean isShowLog) {
        if (isShowLog) {
     ...
     * @param isShowLog 是否显示
     */
    public static void e2(String tag, String message, boolean isShowLog) {
     ...
     */
    public static void e2(String message, boolean isShowLog) {
     ...
     * @param isShowLog isShowLog
     */
    public static void i2(String tag, String message, boolean isShowLog) {
     ...
     * @param isShowLog isShowLog
     */
    public static void i2(String message, boolean isShowLog) {
     ...
     * @param isShowLog isShowLog
     */
    public static void d2(String tag, String message, boolean isShowLog) {
     ...
     * @param isShowLog isShowLog
     */
    public static void d2(String message, boolean isShowLog) {
