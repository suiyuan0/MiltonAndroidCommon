...
package com.milton.common.qrcode.handler;
...
import com.milton.common.qrcode.CaptureActivity;
import com.milton.common.qrcode.DecodeThread;
import com.milton.common.qrcode.Listener.ViewfinderResultPointCallback;
        ...
        if (message.what == R.id.restart_preview) {
            ...
            if (bundle != null) {
                ...
                if (compressedBitmap != null) {
                    bitmap = BitmapFactory.decodeByteArray(compressedBitmap,
