package com.milton.common.pickerview.view;
...
import com.milton.common.pickerview.listener.OnItemSelectedListener;
...
public class WheelTime {
    ...
    public void setPicker(int year, int month, int day, int h, int m, int s) {
        ...
        wv_second.setLabel(context.getString(R.string.pickerview_seconds));// 添加文字
        ...
        wv_second.setTextSize(textSize);
