...
import com.milton.common.pickerview.view.WheelTime;
...
public class TimePickerView extends BasePickerView implements View.OnClickListener {
    public enum Type {
        ALL, YEAR_MONTH_DAY, HOURS_MINS, MONTH_DAY_HOUR_MIN, YEAR_MONTH, MIN_SECOND,
    ...
    public void setTime(int seconds) {
        wheelTime.setPicker(0, 0, 0, 0, seconds / 60, seconds % 60);
    }
//    /**
//     * 指定选中的时间，显示选择器
//     *
